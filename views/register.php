        ...
        <div class="row h-100 m-0">
            <div class="card w-25 my-auto mx-auto">
                ...
                <div class="card-body">
                    <form action="../actions/register.php" method="post">
                        ...
                        <!-- Bold to add emphasis -->
                         ...
                         <div class="mb-5">
                            ...
                            <input type="password" name="password" id="password" class="form-control" maxlength="8" aria-describedby="password-help" required>
                    ...
                    <p class="text-center mt-3 small">Registered alreadey? <a href="../views">Log in.</a></p>
